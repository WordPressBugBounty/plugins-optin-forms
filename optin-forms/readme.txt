...
= 1.3.7 (April 10th, 2024) =
* Security fixes

= 1.3.6 (December 28th, 2023) =
* Minor fixes

= 1.3.5 (November 15th, 2023 ) =
* Minor fixes

= 1.3.4 (November 6th, 2023 ) =
* Changed tabcontent JS plugin with a custom approach

= 1.3.3 (August 8th, 2023) =
* Security fixes

= 1.3.2 (July 7th, 2023) =
* JavaScript fix

= 1.3.1 (March 23rd, 2023) =
* Fixes issue with "exclude IDs" for placement when on a custom post type
* Fixes issue with MailerLite forms not working properly
