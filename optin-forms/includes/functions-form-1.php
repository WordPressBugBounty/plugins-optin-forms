...
function optinforms_form1_default_title_font() {
	...
	if ( $optinforms_form1_title_font == 'Default' ) {
		$optinforms_form1_title_font = 'inherit';
	}
...
function optinforms_form1_default_subtitle_font() {
	...
	if ( $optinforms_form1_subtitle_font == 'Default' ) {
		$optinforms_form1_subtitle_font = 'inherit';
	}
...
function optinforms_form1_default_fields_font() {
	...
	if ( $optinforms_form1_fields_font == 'Default' ) {
		$optinforms_form1_fields_font = 'inherit';
	}
...
function optinforms_form1_default_button_text_font() {
	...
	if ( $optinforms_form1_button_text_font == 'Default' ) {
		$optinforms_form1_button_text_font = 'inherit';
	}
...
function optinforms_form1_default_disclaimer_font() {
	...
	if ( $optinforms_form1_disclaimer_font == 'Default' ) {
		$optinforms_form1_disclaimer_font = 'inherit';
	}
...
function optinforms_form1_get_width() {
	...
	elseif($optinforms_form1_width == 1) {
		return "style=\"width:" . esc_attr( optinforms_form1_default_width_pixels() ) . "px\"";
	}
}
