    ...
    <div id="optinforms-form2-container">
        <div id="optinforms-form2" style="background: <?php echo esc_attr(optinforms_form2_default_background()); ?>;">
            ...
            <div id="optinforms-form2-email-field-container" <?php if (get_option('optinforms_form2_hide_title') == '1' && get_option('optinforms_form2_hide_disclaimer') == '1') { echo 'style="width:80%;"'; } elseif (get_option('optinforms_form2_hide_title') == '1') { echo 'style="width:62%;"'; } elseif (get_option('optinforms_form2_hide_disclaimer') == '1') { echo 'style="width:48%;"'; } ?>>
                <input type="text" id="optinforms-form2-email-field" placeholder="<?php echo esc_attr(do_shortcode(optinforms_form2_default_email_field())); ?>" style="font-family:<?php echo esc_attr(optinforms_form2_default_fields_font()); ?>; font-size:<?php echo esc_attr(optinforms_form2_default_fields_size()); ?>; color:<?php echo esc_attr(optinforms_form2_default_fields_color()); ?>;" />
            </div><!--optinforms-form2-email-field-container-->
            <div id="optinforms-form2-button-container">
                <input type="button" id="optinforms-form2-button" value="<?php echo esc_attr(do_shortcode(optinforms_form2_default_button_text())); ?>" style="font-family:<?php echo esc_attr(optinforms_form2_default_button_text_font()); ?>; font-size:<?php echo esc_attr(optinforms_form2_default_button_text_size()); ?>; color:<?php echo esc_attr(optinforms_form2_default_button_text_color()); ?>; background-color:<?php echo esc_attr(optinforms_form2_default_button_background()); ?>" />
