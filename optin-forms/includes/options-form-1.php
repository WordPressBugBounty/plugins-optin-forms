                        ...
                        <div class="toggle-container" style="display: none;">
                            <div class="optiongroup">
                                ...
                                <div class="optionmiddle">
                                    <input type="text" id="optinforms_form1_background" name="optinforms_form1_background" class="optinforms-color" value="<?php echo esc_attr( optinforms_form1_default_background() ); ?>" data-default-color="#FFFFFF" />
                                    <script>
                            ...
                            <div class="optiongroup">
                                ...
                                <div class="optionmiddle">
                                    <input type="text" id="optinforms_form1_border" name="optinforms_form1_border" class="optinforms-color" value="<?php echo esc_attr( optinforms_form1_default_border() ); ?>" data-default-color="#E0E0E0" />
                                    <script>
                                        jQuery(document).ready(function($){
                            ...
                            <div class="optiongroup">
                                ...
                                <div class="optionmiddle">
                                    <input type="text" id="optinforms_form1_title_color" name="optinforms_form1_title_color" class="optinforms-color" value="<?php echo esc_attr( optinforms_form1_default_title_color() ); ?>" data-default-color="#eb432c" <?php if (get_option('optinforms_form1_hide_title')== '1') { echo 'disabled'; } ?> />
                                    <script>
                                        jQuery(document).ready(function($){
                            ...
                            <div class="optiongroup">
                                ...
                                <div class="optionmiddle">
                                    <input type="text" id="optinforms_form1_subtitle_color" name="optinforms_form1_subtitle_color" class="optinforms-color" value="<?php echo esc_attr( optinforms_form1_default_subtitle_color() ); ?>" data-default-color="#000000" <?php if (get_option('optinforms_form1_hide_subtitle')== '1') { echo 'disabled'; } ?> />
                                    <script>
                                        jQuery(document).ready(function($){
                            ...
                            <div class="optiongroup">
                                ...
                                <div class="optionmiddle">
                                    <input type="text" id="optinforms_form1_fields_color" name="optinforms_form1_fields_color" class="optinforms-color" value="<?php echo esc_attr( optinforms_form1_default_fields_color() ); ?>" data-default-color="#666666" />
                                    <script>
                                        jQuery(document).ready(function($){
                            ...
                            <div class="optiongroup">
                                ...
                                <div class="optionmiddle">
                                    <input type="text" id="optinforms_form1_button_text_color" name="optinforms_form1_button_text_color" class="optinforms-color" value="<?php echo esc_attr( optinforms_form1_default_button_text_color() ); ?>" data-default-color="#FFFFFF" />
                                    <script>
                                        jQuery(document).ready(function($){
                            ...
                            <div class="optiongroup">
                                ...
                                <div class="optionmiddle">
                                    <input type="text" id="optinforms_form1_button_background" name="optinforms_form1_button_background" class="optinforms-color" value="<?php echo esc_attr( optinforms_form1_default_button_background() ); ?>" data-default-color="#20A64C" />
                                    <script>
                                        jQuery(document).ready(function($){
                            ...
                            <div class="optiongroup">
                                ...
                                <div class="optionmiddle">
                                    <input type="text" id="optinforms_form1_disclaimer_color" name="optinforms_form1_disclaimer_color" class="optinforms-color" value="<?php echo esc_attr( optinforms_form1_default_disclaimer_color() ); ?>" data-default-color="#666666" <?php if (get_option('optinforms_form1_hide_disclaimer')== '1') { echo 'disabled'; } ?> />
                                    <script>
                                        jQuery(document).ready(function($){
                            ...
                            <div class="optiongroup">
                                ...
                                <div class="optionmiddle">
                                    ...
                                    <input type="text" id="optinforms_form1_width_pixels" name="optinforms_form1_width_pixels" value="<?php echo esc_attr( optinforms_form1_default_width_pixels() ); ?>" class="fixed-width" <?php echo optinforms_form1_disabled_width_pixels(); ?> /> <p class="fixed-width-px"><?php echo __('px', 'optin-forms'); ?></p>
                                    <div class="clear"></div>
                                </div><!--optionmiddle-->
                                <div class="optionlast">
