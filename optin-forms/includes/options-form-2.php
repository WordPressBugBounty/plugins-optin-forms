                    ...
                    <div class="toggle-container" style="display: none;">
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form2_background" name="optinforms_form2_background" class="optinforms-color" value="<?php echo esc_attr( optinforms_form2_default_background() ); ?>" data-default-color="#266d7c" />
                                <script>
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form2_title_color" name="optinforms_form2_title_color" class="optinforms-color" value="<?php echo esc_attr( optinforms_form2_default_title_color() ); ?>" data-default-color="#ffffff" <?php if (get_option('optinforms_form2_hide_title')== '1') { echo 'disabled="disabled"'; } ?> />
                                <script>
                                    jQuery(document).ready(function($){
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form2_fields_color" name="optinforms_form2_fields_color" class="optinforms-color" value="<?php echo esc_attr( optinforms_form2_default_fields_color() ); ?>" data-default-color="#000000" />
                                <script>
                                    jQuery(document).ready(function($){
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form2_button_text_color" name="optinforms_form2_button_text_color" class="optinforms-color" value="<?php echo esc_attr( optinforms_form2_default_button_text_color() ); ?>" data-default-color="#FFFFFF" />
                                <script>
                                    jQuery(document).ready(function($){
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form2_button_background" name="optinforms_form2_button_background" class="optinforms-color" value="<?php echo esc_attr( optinforms_form2_default_button_background() ); ?>" data-default-color="#49A3FE" />
                                <script>
                                    jQuery(document).ready(function($){
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form2_disclaimer_color" name="optinforms_form2_disclaimer_color" class="optinforms-color" value="<?php echo esc_attr( optinforms_form2_default_disclaimer_color() ); ?>" data-default-color="#ffffff" <?php if (get_option('optinforms_form2_hide_disclaimer')== '1') { echo 'disabled="disabled"'; } ?> />
                                <script>
                                    jQuery(document).ready(function($){
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                ...
                                <input type="text" id="optinforms_form2_width_pixels" name="optinforms_form2_width_pixels" value="<?php echo esc_attr( optinforms_form2_default_width_pixels() ); ?>" class="fixed-width" <?php echo optinforms_form2_disabled_width_pixels(); ?> /> <p class="fixed-width-px"><?php echo __('px', 'optin-forms'); ?></p>
                                <div class="clear"></div>
                            </div><!--optionmiddle-->
                            <div class="optionlast">
