                ...
                <div class="toggle-wrap">
                    ...
                    <div class="toggle-container" style="display: none;">
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form_exclude_posts" name="optinforms_form_exclude_posts" value="<?php echo esc_attr( optinforms_form_exclude_posts() ); ?>" <?php if (get_option('optinforms_form_placement_post')== '4') { echo 'disabled="disabled"'; } ?> />
                            </div><!--optionmiddle-->
                            <div class="optionlast">
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form_exclude_pages" name="optinforms_form_exclude_pages" value="<?php echo esc_attr( optinforms_form_exclude_pages() ); ?>" <?php if (get_option('optinforms_form_placement_page')== '4') { echo 'disabled="disabled"'; } ?> />
                            </div><!--optionmiddle-->
                            <div class="optionlast">
