                    ...
                    <div class="toggle-container" style="display: none;">
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form5_background" name="optinforms_form5_background" class="optinforms-color" value="<?php echo esc_attr( optinforms_form5_default_background() ); ?>" data-default-color="#333333" />
                                <script>
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form5_title_color" name="optinforms_form5_title_color" class="optinforms-color" value="<?php echo esc_attr( optinforms_form5_default_title_color() ); ?>" data-default-color="#fb6a13" <?php if (get_option('optinforms_form5_hide_title')== '1') { echo 'disabled="disabled"'; } ?> />
                                <script>
                                    jQuery(document).ready(function($){
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form5_subtitle_color" name="optinforms_form5_subtitle_color" class="optinforms-color" value="<?php echo esc_attr( optinforms_form5_default_subtitle_color() ); ?>" data-default-color="#CCCCCC" <?php if (get_option('optinforms_form5_hide_subtitle')== '1') { echo 'disabled="disabled"'; } ?> />
                                <script>
                                    jQuery(document).ready(function($){
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form5_fields_color" name="optinforms_form5_fields_color" class="optinforms-color" value="<?php echo esc_attr( optinforms_form5_default_fields_color() ); ?>" data-default-color="#000000" />
                                <script>
                                    jQuery(document).ready(function($){
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form5_button_text_color" name="optinforms_form5_button_text_color" class="optinforms-color" value="<?php echo esc_attr( optinforms_form5_default_button_text_color() ); ?>" data-default-color="#FFFFFF" />
                                <script>
                                    jQuery(document).ready(function($){
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form5_button_background" name="optinforms_form5_button_background" class="optinforms-color" value="<?php echo esc_attr( optinforms_form5_default_button_background() ); ?>" data-default-color="#fb6a13" />
                                <script>
                                    jQuery(document).ready(function($){
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form5_disclaimer_color" name="optinforms_form5_disclaimer_color" class="optinforms-color" value="<?php echo esc_attr( optinforms_form5_default_disclaimer_color() ); ?>" data-default-color="#727272" <?php if (get_option('optinforms_form5_hide_disclaimer')== '1') { echo 'disabled="disabled"'; } ?> />
                                <script>
                                    jQuery(document).ready(function($){
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                ...
                                <input type="text" id="optinforms_form5_width_pixels" name="optinforms_form5_width_pixels" value="<?php echo esc_attr( optinforms_form5_default_width_pixels() ); ?>" class="fixed-width" <?php echo optinforms_form5_disabled_width_pixels(); ?> /> <p class="fixed-width-px"><?php echo __('px', 'optin-forms'); ?></p>
                                <div class="clear"></div>
                            </div><!--optionmiddle-->
                            <div class="optionlast">
