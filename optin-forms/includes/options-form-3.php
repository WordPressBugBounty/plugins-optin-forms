                    ...
                    <div class="toggle-container" style="display: none;">
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form3_background" name="optinforms_form3_background" class="optinforms-color" value="<?php echo esc_attr( optinforms_form3_default_background() ); ?>" data-default-color="#FFFFFF" />
                                <script>
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form3_title_color" name="optinforms_form3_title_color" class="optinforms-color" value="<?php echo esc_attr( optinforms_form3_default_title_color() ); ?>" data-default-color="#505050" <?php if (get_option('optinforms_form3_hide_title')== '1') { echo 'disabled="disabled"'; } ?> />
                                <script>
                                    jQuery(document).ready(function($){
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form3_subtitle_color" name="optinforms_form3_subtitle_color" class="optinforms-color" value="<?php echo esc_attr( optinforms_form3_default_subtitle_color() ); ?>" data-default-color="#505050" <?php if (get_option('optinforms_form3_hide_subtitle')== '1') { echo 'disabled="disabled"'; } ?> />
                                <script>
                                    jQuery(document).ready(function($){
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form3_fields_color" name="optinforms_form3_fields_color" class="optinforms-color" value="<?php echo esc_attr( optinforms_form3_default_fields_color() ); ?>" data-default-color="#666666" />
                                <script>
                                    jQuery(document).ready(function($){
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form3_button_text_color" name="optinforms_form3_button_text_color" class="optinforms-color" value="<?php echo esc_attr( optinforms_form3_default_button_text_color() ); ?>" data-default-color="#FFFFFF" />
                                <script>
                                    jQuery(document).ready(function($){
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form3_button_background" name="optinforms_form3_button_background" class="optinforms-color" value="<?php echo esc_attr( optinforms_form3_default_button_background() ); ?>" data-default-color="#49A3FE" />
                                <script>
                                    jQuery(document).ready(function($){
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                ...
                                <input type="text" id="optinforms_form3_width_pixels" name="optinforms_form3_width_pixels" value="<?php echo esc_attr( optinforms_form3_default_width_pixels() ); ?>" class="fixed-width" <?php echo optinforms_form3_disabled_width_pixels(); ?> /> <p class="fixed-width-px"><?php echo __('px', 'optin-forms'); ?></p>
                                <div class="clear"></div>
                            </div><!--optionmiddle-->
                            <div class="optionlast">
