                    ...
                    <div class="toggle-container" style="display: none;">
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form4_background" name="optinforms_form4_background" class="optinforms-color" value="<?php echo esc_attr( optinforms_form4_default_background() ); ?>" data-default-color="#FCFCFC" />
                                <script>
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form4_border" name="optinforms_form4_border" class="optinforms-color" value="<?php echo esc_attr( optinforms_form4_default_border() ); ?>" data-default-color="#ECEAED" />
                                <script>
                                    jQuery(document).ready(function($){
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form4_title_color" name="optinforms_form4_title_color" class="optinforms-color" value="<?php echo esc_attr( optinforms_form4_default_title_color() ); ?>" data-default-color="#505050" <?php if (get_option('optinforms_form4_hide_title')== '1') { echo 'disabled="disabled"'; } ?> />
                                <script>
                                    jQuery(document).ready(function($){
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form4_subtitle_color" name="optinforms_form4_subtitle_color" class="optinforms-color" value="<?php echo esc_attr( optinforms_form4_default_subtitle_color() ); ?>" data-default-color="#505050" <?php if (get_option('optinforms_form4_hide_subtitle')== '1') { echo 'disabled="disabled"'; } ?> />
                                <script>
                                    jQuery(document).ready(function($){
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form4_fields_color" name="optinforms_form4_fields_color" class="optinforms-color" value="<?php echo esc_attr( optinforms_form4_default_fields_color() ); ?>" data-default-color="#666666" />
                                <script>
                                    jQuery(document).ready(function($){
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form4_button_text_color" name="optinforms_form4_button_text_color" class="optinforms-color" value="<?php echo esc_attr( optinforms_form4_default_button_text_color() ); ?>" data-default-color="#1d629b" />
                                <script>
                                    jQuery(document).ready(function($){
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form4_button_background" name="optinforms_form4_button_background" class="optinforms-color" value="<?php echo esc_attr( optinforms_form4_default_button_background() ); ?>" data-default-color="#faff5b" />
                                <script>
                                    jQuery(document).ready(function($){
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form4_disclaimer_color" name="optinforms_form4_disclaimer_color" class="optinforms-color" value="<?php echo esc_attr( optinforms_form4_default_disclaimer_color() ); ?>" data-default-color="#999999" <?php if (get_option('optinforms_form4_hide_disclaimer')== '1') { echo 'disabled="disabled"'; } ?> />
                                <script>
                                    jQuery(document).ready(function($){
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                ...
                                <input type="text" id="optinforms_form4_width_pixels" name="optinforms_form4_width_pixels" value="<?php echo esc_attr( optinforms_form4_default_width_pixels() ); ?>" class="fixed-width" <?php echo optinforms_form4_disabled_width_pixels(); ?> /> <p class="fixed-width-px"><?php echo __('px', 'optin-forms'); ?></p>
                                <div class="clear"></div>
                            </div><!--optionmiddle-->
                            <div class="optionlast">
