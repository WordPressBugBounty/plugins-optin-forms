...
function optinforms_form3_default_title_font() {
	...
	if ( $optinforms_form3_title_font == 'Default' ) {
		$optinforms_form3_title_font = 'inherit';
	}
...
function optinforms_form3_default_subtitle_font() {
	...
	if ( $optinforms_form3_subtitle_font == 'Default' ) {
		$optinforms_form3_subtitle_font = 'inherit';
	}
...
function optinforms_form3_default_fields_font() {
	...
	if ( $optinforms_form3_fields_font == 'Default' ) {
		$optinforms_form3_fields_font = 'inherit';
	}
...
function optinforms_form3_default_button_text_font() {
	...
	if ( $optinforms_form3_button_text_font == 'Default' ) {
		$optinforms_form3_button_text_font = 'inherit';
	}
...
function optinforms_form3_get_width() {
	...
	elseif($optinforms_form3_width == 1) {
		return "style=\"width:" . esc_attr( optinforms_form3_default_width_pixels() ) . "px\"";
	}
}
